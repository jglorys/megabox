...
<div class="d-flex align-itmes-center">
	...
	<div class="col-4">
		...
		<div class="h-50 d-flex align-items-end justify-content-around">
			<a href="/event/event_view" class="gnb-txt-event"><img alt="gnb event" src="https://img.megabox.co.kr/static/pc/images/common/gnb/gnb-txt-event.png"></a>
    		...
    		<table class="table mt-4">
				...
				<tbody>
					<tr class="text-center">
						...
						<td style="border-top: none; border-bottom: none; height:70px;"><a href="/event/event_view" style="color: white; text-decoration:none">진행중 이벤트</a></td>
					...
					<tr class="text-center">
						...
						<td style="border-top: none; border-bottom: none; height:70px;"><a href="/event/event_view"  style="color: white; text-decoration:none">지난 이벤트</a></td>
